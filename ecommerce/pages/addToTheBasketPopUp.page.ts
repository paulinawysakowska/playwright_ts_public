...
export class AddToTheBasketPopUp {
    ...
    constructor(page: Page) {
        ...
        this.goToTheBasketButton = page.locator('button.px-8.h-12.text-sm.font-semibold.tracking-wide.rounded.text-white.bg-main-gradient.hover\\:to-blue-smalt.w-full.px-2.sm\\:w-56.sm\\:justify-self-end');
    ...
    async verifyProductDetailsInPopUp(expectedTitle: string, expectedPrice: string) {
