...
import { createAccountTxt, logInButtonTxt, logInByFacebookTxt, logInByGoogleTxt, logInHeaderTxt, rememberMeTxt, resetPasswordTxt } from '../dicts/logIn-pop-up-dict';
...
export class LogInPopUpPage {
  ...
  readonly logInButton: Locator;
    ...
    constructor(page: Page) {
        ...
        this.logInButton = page.locator('button.px-8.h-12.text-sm.font-semibold.tracking-wide.rounded.text-white.bg-main-gradient.hover\\:to-blue-smalt.w-full[ng-click="$ctrl.recaptchaShow = true"]');
    ...
    async checkLogInPopup() {
        const elements = [
            ...
            { locator: this.logInButton, text: logInButtonTxt, checkClick: true},
