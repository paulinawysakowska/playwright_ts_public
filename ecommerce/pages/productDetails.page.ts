...
export class ProductDetailsPage {
    ...
    constructor(page: Page) {
        ...
        this.productPrice = page.locator('div.inline-flex.items-center.mt-2.flex-wrap > div.font-bold.leading-8.text-3xl').first();
        this.addToBasketButton = page.getByRole('button', { name: 'Dodaj do koszyka' }).first();
