...
import { additionalVerificationTxt, agreementTxt, emailPlaceholderTxt, pageHeaderTxt, passwordPlaceholderTxt, postalCodePlaceholderTxt } from '../dicts/register-dict';
...
export class RegisterPage {
    ...
    constructor(page: Page) {
        ...
        this.additionalVerificationField = page.locator('div.heading.heading-regular');
        this.captchaFrame = page.frameLocator('iframe[src*="recaptcha/api2"]').first();
    ...
    async checkRegisterPage() {
        const elements = [
            ...
            { locator: this.emailField, checkClick: true, placeholder: emailPlaceholderTxt},
            { locator: this.passwordField, checkClick: true, placeholder:  passwordPlaceholderTxt},
            { locator: this.postalCodeField, checkClick: true, placeholder:  postalCodePlaceholderTxt},
            { locator: this.additionalVerificationField, text: additionalVerificationTxt},
    ...
    async checkRegisterSuccess() {
        ...
        const successMessage = await this.page.locator('div.heading.heading-regular').textContent();
